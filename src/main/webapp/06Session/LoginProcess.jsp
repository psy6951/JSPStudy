...
<%@ page language="java" contentType="text/html; charset=UTF-8"
 ...
 //위 4개의 정보를 인수로 DAO 인스턴스를 생성한다. 여기서 DB연결이 완료됨.
 ...
 if(memberDTO.getId() != null){
	 ...
	 /*
	 세션 영역에 저장된 속성값은 페이지를 이동하더라도 유지되므로 
	 로그인페이지로 이동한다. 그리고 웹브라우저를 완전히 닫을 때까지 
	 저장된 정보는 유지된다.
	 */
	 ...
	 /*
	 로그인에 실패한 경우에는 request 영역에 에러메시지를 저장한 후 
	 로그인페이지로 포워드한다. request 영역은 포워드 한 페이지까지 
	 데이터를 공유한다.
	 */
