...
<!DOCTYPE html>
<html>
<head><title>내장객체 - application</title></head>
<body>
	<!-- web.xml에 <context-param>으로 설정한 값을 
	내장객체를 통해 읽어올 수 있다. --> 
	...
	<!-- 
	이클립스에서는 우리가 직접 작성한 파일을 직접 실행하지 않고 
	.metadata 디엑토리 하위에 프로젝트와 동일한 Tomcat 환경을 만들어서 
	복사본 파일을 실행하게 된다. 
	따라서 위에서의 물리적 경로는 .metadata 하위의 경로가 된다.
	 -->
