...
getTime(): 날짜는 1970-01-01부터 지금까지의 시간을 
		초단위로 반환해주는 메서드.
*/
//날짜와 시간의 서식을 지정
SimpleDateFormat s = new SimpleDateFormat("yyyy-MM-dd HH:mm");
//String타입의 폼값을 날짜 형식으로 변경한 후 타임스탬프를 얻어온다.
long add_date = s.parse(request.getParameter("add_date")).getTime();
//숫자형식으로 전송된 값을 정수로 변환
...
<body>
	...
	/*
	첫번째 출력결과에서 myNumber라는 헤어명이 2번 출력되는데 이때 동일한 값 
	8282가 출력된다. 
