...
<body>
	...
	request 영역에 에러메시지를 저장한 후 현재페이지로 forward한다.
	request 영역은 forward된 페이지까지는 공유되므로 아래의 메시지를 
	출력할 수 있다.
	 -->
	<span style="color: red; font-size:1.2em;">
	<!-- if문 대신 삼항 연산자를 통해 분기 -->
	...
	function validateForm(form) {
		...
		접근시에는 name속성값을 사용하고, value는 입력된 값을 가리킨다.
		*/
	...
	<!-- 
	로그인 폼에서 아이디, 비번을 입력한 후 submit 버튼을 누르면 
	action에 설정된 경로로 폼값이 전송된다.
	submit 버튼을 누를 때 Javascript 함수를 호출하게 되는데 
